...
class Boom < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "1450b926867dc7a6a19adf98c181de0054b7d9118d4009c079e0739fc365f4e0"
    end
    on_intel do
      url "https://github.com/alxjrvs/boom/releases/download/v#{version}/boom-bun-darwin-x64"
      sha256 "65c250411eab3173ea647a2d5efc4e2c816330c8753a66927cf6716a05d0ece9"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "7bb17ae9df5274e31a02bb737c17d95666d75e2ab38148eeb18374ecea3b239c"
    end
    on_intel do
      url "https://github.com/alxjrvs/boom/releases/download/v#{version}/boom-bun-linux-x64"
      sha256 "6107c7891b93e50ab19fba5494c27591a4c1eafbba8722a266dc0544c42e280a"
    end
  end
